...
Experiment Result
The whole communication chain works normally. MQTTX subscribes to the topics and successfully receives formatted JSON payload.
Modbus read/write function and sensor data simulation are verified.
Project Description
